...
namespace JasperFx.Reflection.Tests;
...
public class TypeExtensionsTester
{
    ...
    public void is_nullable_of_T()
    {
        ...
        typeof(int?).IsNullableOfT().ShouldBeTrue();
    }
    ...
    public void is_nullable_of_a_given_type()
    {
        ...
        typeof(DateTime?).IsNullableOf(typeof(int)).ShouldBeFalse();
    ...
    public void is_type_or_nullable_of_T()
    {
        ...
        typeof(bool?).IsTypeOrNullableOf<bool>().ShouldBeTrue();
        typeof(DateTime?).IsTypeOrNullableOf<bool>().ShouldBeFalse();
    ...
    {
        GetType().IsInNamespace("wrong").ShouldBeFalse();
        GetType().IsInNamespace(GetType().Namespace + ".something").ShouldBeFalse();
        GetType().IsInNamespace(GetType().Namespace).ShouldBeTrue();
        GetType().IsInNamespace(GetType().GetTypeInfo().Assembly.GetName().Name).ShouldBeTrue();
    ...
    public void is_concrete_type_of_T()
    {
        ...
        GetType().IsConcreteTypeOf<IMessage>().ShouldBeFalse();
    ...
    {
        typeof(int?).GetInnerTypeFromNullable().ShouldBe(typeof(int));
    }
