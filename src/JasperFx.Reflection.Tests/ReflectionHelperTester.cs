...
namespace JasperFx.Reflection.Tests
{
    public class ReflectionHelperTester
    {
        ...
        public void getMemberExpression_should_throw_when_not_a_member_access()
        {
            ...
            Should.Throw<ArgumentException>(() => typeAsExpression.GetMemberExpression(true)).Message.ShouldContain("Not a member access");
        }
        ...
        public void GetProperty_should_throw_if_not_property_expression()
        {
            ...
            {
                ReflectionHelper.GetProperty(expression);
